# Ecology Building Society - Knowledge Base

## Overview
- **Founded:** 1981, by David Pedley who persuaded 10 people to contribute £500 each to establish a society providing mortgages for environmentally sustainable properties
- **Headquarters:** 7 Belton Road, Silsden, Keighley, West Yorkshire, BD20 0EE (note: Wikipedia says Silsden; postal address uses Keighley)
- **Total assets:** ~£337 million (December 2024), up from £304m (2022) and £256m (2021) — balance sheet increased by over £110m (49%) in five years
- **Mortgage assets:** Over £250 million (2024)
- **Members:** Over 15,000 including over 1,400 mortgage customers
- **Employees:** Over 70 colleagues (2024/25), up from 45 (2022) and 39 (2021) — significant growth reflecting digital transformation investment
- **Revenue:** ~$35M annually (estimated, July 2025)
- **Net Interest Margin:** 2.45% (December 2024)
- **Chief Executive:** Gareth Griffiths (appointed 2022, first full year results reported March 2024)
- **Chair:** Louise Pryor
- **CFO:** Chris White
- **BSA member:** Yes
- **FSCS protected:** Yes, up to £120,000 per eligible depositor
- **Regulator:** PRA and FCA (FCA Mutuals Public Register number 733B, Financial Services Register reference 162090)
- **Identity:** UK's specialist ethical/green building society — the only building society dedicated entirely to ecological and sustainable lending. First building society awarded the Fair Tax Mark (2016). Ethical Consumer Best Buy for both mortgages and savings (ethiscore of 100%)
- **Legal structure:** Incorporated in England and Wales under the Building Societies Act 1986, mutual ownership, no subsidiaries

## Branch Network
- **Single location** — head office in Silsden, West Yorkshire
- No high street branch network
- All business conducted via phone, post, and online
- No Post Office cash deposit facility (noted as a customer wish)
- UK-based staff handle all calls — frequently praised by customers

## Products

### Savings
All savings accounts are simple, transparent, variable rate products. Interest paid gross (no tax deducted). Ecology commits to never investing savers' money in fossil fuels, mining, arms trade, deforestation, or gambling.

| Account | Rate (AER) | Min Opening | Max Investment | Notice |
|---------|-----------|-------------|----------------|--------|
| **Regular Savings** | 3.00% | £10 | £250/month (£3,000/year) | None |
| **Ecology Cash ISA** | 2.80% (tax-free) | £25 | £20,000 (2025/26 tax year) | None |
| **35-Day Notice** | 2.75% | £500 | £500,000 | 35 days |
| **Easy Access** | 2.30% | £25 | £500,000 | None |

- ISA transfers accepted from other providers
- Accounts available for young people/children (35-Day Notice, Easy Access, Regular Savings)
- Same interest rate regardless of balance (Easy Access)
- No fixed-rate bonds currently offered
- No monthly interest ISA option (customer request noted)

### Mortgages (Eco/Sustainable Focus)

Ecology offers an extensive range of specialist mortgage products, all requiring environmental or social benefit. Variable rate only (no fixed rates). Maximum loan size generally £1.25m for residential, £750,000 for some specialist products.

#### Residential Mortgages

| Product | Rate (Variable) | Max LTV | Max Loan | Notes |
|---------|----------------|---------|----------|-------|
| **Eco Home** | 4.19% | 80% | £1.25m | For purchasing/remortgaging energy-efficient homes (min EPC 85+). ERC in first 2 years |
| **Eco Reward** (existing members) | 3.99% | 80% | £1.25m | Same as Eco Home but for existing Ecology members |
| **Shared Ownership** | 4.19% | 95% | £750k | Energy-efficient affordable housing. ERC in first 2 years |
| **Community Living** | 5.34% | 90% | £750k | For co-housing scheme properties. No ERC |
| **Affordable Local Homes** | 5.54% | 95% | £750k | Discounted Market Sale Homes. No ERC |
| **Self-Build 65%** | 5.69% | 65% | £1.25m | New product (late 2025). No ERC |
| **Self-Build 80%** | 5.89% | 80% | £1.25m | No ERC |
| **Off-Site Build** | 5.69% | 80% | £750k | Modular/off-site build with supported suppliers. ERC in first 3 years |
| **Off-Site Build (advanced payment)** | 5.99% | 80% | £750k | ERC in first 3 years |
| **Renovation 80%** | 4.99% | 80% | £1.25m | Light-touch renovations (heat pumps, insulation, solar). ERC in first 3 years |
| **Renovation 90%** | 5.79% | 90% | £750k | More extensive renovations with staged payments. ERC in first 3 years |
| **Conversion** | 6.04% | 80% | £750k | Must achieve min EPC B (SAP 85+). ERC in first 2 years |
| **Buy-to-Let** | 6.79% | 80% | £750k | Must meet energy ratings. Rental income ≥135% of mortgage payment |

#### C-Change Discounts (Flagship Feature)
Ecology's unique award-winning mortgage discount scheme that reduces the variable rate for the **lifetime of the mortgage** based on energy performance achieved:

**Sustainable Homes Discounts (new builds/self-builds):**
| Energy Standard | Rating | Discount |
|----------------|--------|----------|
| Passivhaus | Passivhaus certified | 1.50% |
| Passivhaus | PHPP Modelled | 0.75% |
| EPC | A (SAP 110+) | 1.25% |
| EPC | A (SAP 100-109) | 1.00% |
| EPC | A (SAP 92-99) | 0.75% |
| EPC | B (SAP 88-91) | 0.50% |
| AECB | CarbonLite Building Standard | 1.00% |

**Retrofit Discounts (renovations):**
- 0.25% discount for each EPC grade improvement
- Passivhaus EnerPHit: 1.50%
- EnerPHit PHPP Modelled: 0.75%
- AECB CarbonLite Building Standard: 1.00%

Additional incentive: Heat pump cashback — £500 for air source, £1,000 for ground source heat pump.

#### Community & Commercial Mortgages
- Community-led housing (co-ops, housing associations, Community Land Trusts, co-housing groups, Mutual Home Ownership Societies)
- Housing developers (small-scale sustainable/residential)
- Community groups and charities
- Sustainable businesses
- Part-residential properties
- Smallholdings, small woodlands, and moorings

Ecology welcomes non-standard construction: timber frame, straw bale, hempcrete, rammed earth, earth shelter, cob, and other natural materials.

### Other Products
- **Core Capital Deferred Shares (CCDS):** 11% perpetual CCDS listed on The International Stock Exchange (TISE) in Channel Islands (June 2025). New issue of up to £6.5m launched September 2025 (professional/eligible investors only, minimum £5,000). Managed by Allia C&C Limited.
- No current accounts, debit cards, or credit cards
- No insurance products

## Digital & Technology
- **Online banking:** Available via website — allows viewing accounts, making deposits via BACS, and withdrawals to a nominated UK bank account
- **Mobile app:** Not yet available but under active development as part of major digital transformation
- **Core banking overhaul:** Partnership with Monument Technology announced May 2024 to replace core banking platform. Cloud-based, end-to-end platform. Migration expected during 2025.
- **2025 improvements announced (October 2024):**
  - New Ecology app for account management
  - Open new accounts in a few clicks
  - Instant access to information
  - Latest security features
  - Improved website experience
  - Faster payment processing
- **2030 Strategy:** Ambitious digital transformation described as "the biggest period of transformation in Ecology's history"
- **Current limitations:** Online banking described by some customers as "not the most up-to-date system" — no app, basic functionality. Improvements acknowledged as in progress
- **Accounts opened:** Online application available for savings; mortgage enquiries handled by phone with human advisors

## Recent News & Changes (Last 12-18 Months)

### 2025
- **Feb 2026:** Joined TMA Mortgage Club panel, expanding intermediary access
- **Dec 2025:** Refreshed self-build and off-site build mortgage range with rate cuts and new Self-Build 65% LTV product at 5.69%
- **Oct 2025:** Joined Simplybiz panel, giving members access to full range of green mortgages
- **Nov 2025:** Appointed two new Business Development Managers (Pearson and Midgley)
- **Sep 2025:** Launched additional £6.5m CCDS issue for institutional investors
- **Aug 2025:** Launched new Community Living Mortgage for co-housing buyers
- **Jul 2025:** Launched new 80% LTV Renovation Mortgage at 5.29% for green home improvements
- **Jun 2025:** Existing CCDS admitted to TISE Official List
- **May 2025:** Cut rates on Self-Build and Eco Home products (Self-Build to 5.99%, Eco Home to 4.90%)
- **May 2024:** Announced Monument Technology partnership for core banking overhaul
- **Oct 2024:** Announced major online banking improvements and app coming in 2025
- **Mar 2024:** Reported 2023 annual results — mortgage assets grew to £240m+, profits of £1.02m, stable lending of £65m

### 2024 Annual Results (reported early 2025)
- Total assets: ~£337m
- Mortgage assets: £250m+
- Strong Net Interest Margin of 2.45%
- Continued investment in digital transformation and skills

## Customer Sentiment (from Reviews/Trustpilot)

### Trustpilot Rating
- **4.5 / 5** — Rated "Excellent"
- Reviews predominantly unprompted and positive
- Company actively responds to all reviews (Laura, Marketing Manager)

### Smart Money People Rating
- **4.91 / 5** based on 669 reviews
- Savings: 4.91/5 (570 reviews)
- Mortgages: 4.91/5 (99 reviews)
- 94% five-star, 6% four-star, 0% one-to-three star on Smart Money People

### Positive Themes
- **Ethical values/mission:** Customers deeply value knowing their money supports sustainability, not fossil fuels, arms, or deforestation. "One of the very few financial institutions with a genuinely ethical approach"
- **Customer service:** Consistently praised — "always possible to speak to a human," "no horrible call queues or phone bots," friendly, helpful UK-based staff
- **Personal touch:** Staff treat customers as individuals, listen, and support through processes. "Very understanding staff who treated me as an individual"
- **Transparency:** Clear communication about where money goes and how it's used
- **Long-term loyalty:** Many customers for 20-40+ years. "I've been saving with Ecology for 40 years"
- **Mission-driven lending:** Customers praise mortgages for unusual eco projects (straw bale houses, woodland for tree planting, community housing) that mainstream lenders reject
- **Competitive rates:** Considered fair/reasonable, especially given ethical mandate
- **AGMs and community:** Well-attended AGMs at interesting venues, genuine member engagement
- **Fair salary ratios:** Society has a policy on CEO-to-staff pay ratios (though some note ratios have worsened)

### Negative Themes
- **Online banking limitations:** Noted as outdated, no app yet (though improvements in progress)
- **Mortgage process speed:** Isolated complaints about slow mortgage processing, repeated paperwork requests, and lack of updates. One Trustpilot review: "They string you along for months... ask for the same paperwork over and over"
- **No Post Office cash deposits:** Customers wish they could pay in cash via Post Office
- **No monthly interest ISA:** Requested but not offered
- **Small size limitations:** Some wish Ecology were bigger with high street branches and debit cards so they could use it as main bank
- **No fixed-rate mortgages:** All variable rate, which may not suit all borrowers

## Community & Values

### Environmental Mission
Ecology's core purpose is "to improve the environment and society by enabling sustainable buildings and communities." Every loan must demonstrate consistency with their Environmental Policy Statement.

**Vision:** "To support the creation of a fair society in a sustainable world" — measured against three outcomes:
1. People and the environment benefit from homes with good ecological performance
2. People and the environment benefit from sustainable communities
3. People and the environment benefit from a fair and sustainable economy

### What They Fund
- Eco self-builds (including non-standard: straw bale, hempcrete, rammed earth, timber frame, cob)
- Energy-saving renovations and retrofits
- Conversions of derelict/disused buildings
- Co-housing and community-led housing
- Housing co-operatives and associations
- Community Land Trusts
- Charities and community groups
- Smallholdings and small woodlands
- Sustainable businesses
- Organic farming
...
- Ethical Consumer Best Buy (mortgages and savings) — ethiscore 100%
- Fair Tax Mark (first building society, 2016)
- BSA member
- Bank.Green recommended
- Net zero journey — sharing learnings with members, colleagues, and peers
- Supporter of the Nature Bill

## Key Differentiators

1. **Only UK building society dedicated entirely to ecological/sustainable lending** — every mortgage must demonstrate environmental or social benefit
2. **C-Change discount system** — unique lifetime mortgage rate discounts (up to 1.50%) based on energy performance achieved, rewarding borrowers for building/improving energy efficiency
3. **Specialist in unusual/non-standard projects** — will consider projects mainstream lenders reject (straw bale, hempcrete, woodland, derelict conversions, community housing)
4. **Complete ethical transparency** — clear negative screening (no fossil fuels, arms, mining, deforestation, gambling) and positive screening (all lending supports sustainability)
5. **Mutual ownership with genuine member engagement** — well-attended AGMs, member meet-ups at unusual venues, members actively shape the business
6. **Human-first service** — UK-based staff, no call queues or phone bots, personal approach consistently praised
7. **Heat pump cashback** — additional financial incentive for renewable heating installation
8. **Fair Tax Mark holder** — first building society to achieve this
9. **100% Ethical Consumer ethiscore** — top rating across all ethical criteria
10. **Community-led housing expertise** — leading lender for co-housing, Community Land Trusts, housing co-ops, and mutual home ownership
11. **Small but growing rapidly** — assets up 49% in 5 years, staff nearly doubled, ambitious 2030 Strategy with major tech transformation underway
12. **Variable rates only** — all mortgages are variable rate (SVR or discounted variable), no fixed-rate products — simpler but may deter rate-conscious borrowers
...
*Sources: ecology.co.uk, Trustpilot, Smart Money People, Wikipedia, Mortgage Strategy, The Intermediary, Fintech Futures, BSA, various industry sources*
