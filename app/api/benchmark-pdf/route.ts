...
export async function POST(request: NextRequest) {
  try {
    ...
    // If email provided, send via SMTP (nodemailer)
    if (email) {
...
Please find attached the Member Experience Benchmark Report for ${society.name}.

This report analyses customer reviews across Smart Money People and Trustpilot to benchmark ${society.name} against ${benchmarkData.totalSocieties} other building societies across key experience factors.
...
---
Generated by BSA Member Chat | bsa-member-chat.vercel.app`;

      await transporter.sendMail({
        from: `"Woodhurst Consulting" <${smtpFrom}>`,
        to: email,
