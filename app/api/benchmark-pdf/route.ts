...
export async function POST(request: NextRequest) {
  try {
    ...
    const methodology =
      ...
      `Rankings are out of ${totalSocieties} building societies analysed. ` +
      `Scores range from 1-10 where 10 is best. Industry average calculated across all societies.`;
    ...
    if (email) {
      ...
      await transporter.sendMail({
        from: `"Woodhurst Consulting" <${process.env.SMTP_FROM || process.env.SMTP_USER}>`,
        to: email,
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>This report analyses customer reviews across Smart Money People and Trustpilot to benchmark ${society.shortName} against ${totalSocieties} other building societies across key experience factors.</p>
      ...
      console.log(`[EMAIL] Sent benchmark PDF to ${email} for ${society.name}`);
